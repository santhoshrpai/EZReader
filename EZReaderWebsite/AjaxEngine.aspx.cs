...
public partial class AjaxEngine : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataLayer.AddKeyword(lookupWord, Convert.ToInt32(Session["UserID"].ToString()), Server.MapPath("\\EZReader.accdb"));
        ...
        DictionaryModel model = helper.parseDictionaryResult(arg1, arg2);
